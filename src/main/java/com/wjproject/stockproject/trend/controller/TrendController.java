...
public class TrendController {
    ...
    public ResponseEntity<ApiResponse<Void>> addInterestStock(@RequestBody InterestStockRequest request) {

        interestService.addInterestStock(1L, "STOCK_01"/*request.getStockCode()*/);
